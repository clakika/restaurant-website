        ...
        return (
            <div className="Contacts">
                ...
                <div className="Contacts_Socials">
                    ...
                    <FontAwesomeIcon icon={faFacebookSquare} className="Contact_Icon"/>
                    <FontAwesomeIcon icon={faPinterest} className="Contact_Icon"/>
                    <FontAwesomeIcon icon={faTwitter} className="Contact_Icon"/>
                </div>
